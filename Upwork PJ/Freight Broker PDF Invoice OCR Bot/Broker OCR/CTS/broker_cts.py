...
for pdf_file_path in pdf_file_paths:
    ...
    keywords = ['Drayage Fee','CHASSIS SPLIT','CHASSIS FEE', 'Pier Pass Charges', 'International Freight', 'Delivery Cartage', 'Port Waiting Time', 'Yard', 'US CUSTOMS', 'ISF CHARGE', 'Handling Charges', 'Prepull fees', 'DROP FEE','Waiting Time','Yard Sotrage']
