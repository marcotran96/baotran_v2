...
where
	1 = 1
	and us_broker = 242
	and etd >= CURRENT_DATE - INTERVAL '18 months'
	and published = 1 
...
pdf_file_path = 'Y:/po_notice/0f931798fa77be5557060b4f54d2b94f/_9/INVOICE---SLAXSI2301833---YES4ALLGB-30-Aug-23.pdf'
...
keywords = ['Drayage Fee','CHASSIS SPLIT','CHASSIS FEE', 'Pier Pass Charges', 'International Freight'
                ...
                ,'Drop to Anaheim','drop off','YARD STORAGE','PER DIEM CHARGES','DROP TO ANAHEIM','DROP OFF TO ANAHEIM','Drop Off'
                , 'drop to Anaheim','DROP OFF']
